              ...
              builder: (ctx) => Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [
                        Colors.teal.shade200, //Color(0xBB923CB5)
                        Colors.black87,
                ...
                final response = await http.post(Uri.parse(otpurl), body: data).then((value) => {
                ...
                http.post(Uri.parse(signupurl), body: data).then((value) =>
                  {
